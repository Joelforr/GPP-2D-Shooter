...
// AUDIO TASKS
////////////////////////////////////////////////////////////////////////
public abstract class AudioTask: Task
{
    protected readonly AudioSource audioSource;
    protected readonly AudioClip audio;

    protected AudioTask(AudioSource audioS, AudioClip clip)
    {
...
public class PlayAudioTask : AudioTask
{

    public PlayAudioTask(AudioSource audioS, AudioClip clip) : base(audioS, clip)
    {
